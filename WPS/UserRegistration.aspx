        ...
        <div class="row">
            ...
            <div class="col-md-8 bgc">
                ...
                <div class="form-group col-md-6">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="id_email" ErrorMessage="*Email is invalid" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="vg_userreg" Display="Dynamic"></asp:RegularExpressionValidator>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="id_contact" Display="Dynamic" ErrorMessage="*10 digits only" ForeColor="Red" ValidationExpression="[0-9]{10}" ValidationGroup="vg_userreg"></asp:RegularExpressionValidator>
                ...
                <div class="form-group col-md-6">
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="id_cpassword" ControlToCompare="id_password" ErrorMessage="*Password mismatch" ForeColor="Red" Display="Dynamic" ValidationGroup="vg_userreg"></asp:CompareValidator>
                </div>
